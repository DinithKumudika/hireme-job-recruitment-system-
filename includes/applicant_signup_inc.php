                    ...
                    if (checkUid($username) == false) {
                         ...
                         if (checkPwd($password) == false) {
                              ...
                              if (applicantEmailExist($email) == true) {
                                   header("Location: ".ROOT."views/regular_signup.php?error=emailexist&fname=" . $firstName . "&lname=" . $lastName . "&phone=" . $phoneNo . "&uid=" . $username);
                                   exit();
                              } 
                              else {
                                   if (applicantUidExist($username) == true) {
                                        header("Location: ".ROOT."views/regular_signup.php?error=uidexist&fname=" . $firstName . "&lname=" . $lastName . "&email=" . $email . "&phone=" . $phoneNo);
                                        exit();
                                   } 
                                   else {
